...
public class SeekbarWithIntervals extends LinearLayout {
    ...
    private @ColorRes int intervalColor;

    public SeekbarWithIntervals(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.widget_seekbar_with_intervals, this);
    }
    ...
    private TextView createInterval(String interval) {
        View textBoxView = (View) LayoutInflater.from(getContext())
                .inflate(R.layout.widget_seekbar_with_intervals_labels, null);
        ...
        if(intervalColor != 0){
            textView.setTextColor(intervalColor);
        }
        return textView;
    }
    ...
    public void setIntervalColor(@ColorRes int intervalColor) {
